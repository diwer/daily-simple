 ...
 */
public class QnUtil {
    private final static Logger logger = Logger.getLogger("QnUtil");

    private static class SingletonHolder {
        private static final QnUtil INSTANCE = new QnUtil();
    }

    public static final QnUtil getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private static QnUtil instance;
    private Auth auth;
